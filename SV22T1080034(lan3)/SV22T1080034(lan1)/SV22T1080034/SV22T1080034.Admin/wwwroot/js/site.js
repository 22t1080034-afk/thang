...
function loadPage(url) {
    // Làm mờ nội dung cũ để tạo hiệu ứng đang tải
    $(".app-content").css("opacity", "0.5");

    $.ajax({
        url: url,
        type: "GET",
        headers: { "X-Requested-With": "XMLHttpRequest" }, // Rất quan trọng để Controller nhận diện
        success: function (data) {
            // Thay thế nội dung trong vùng container-fluid
            $(".app-content .container-fluid").html(data);
